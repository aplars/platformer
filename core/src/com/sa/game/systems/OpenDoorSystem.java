...
public class OpenDoorSystem extends IteratingSystem {
    ...
    protected void processEntity(final Entity entity, final float deltaTime) {
        ...
        final DoorGroupComponent doorGroupComponent = ComponentMappers.doorGroup.get(entity);
        ...
        for (final CollisionEntity collidee : collisionComponent.entity.collidees) {
            ...
            if (pickUpEntityComponent != null && pickUpEntityComponent.entity!= null && ComponentMappers.keyGroup.get(pickUpEntityComponent.entity) != null) {
                //the door can be opened. Remove the key from the entety that opens the door, set the doors state to open and put an exit at the doors position.
                doorGroupComponent.isOpen = true;
